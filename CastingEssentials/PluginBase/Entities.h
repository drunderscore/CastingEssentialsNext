...
public:
    ...
    static PropOffsetPair RetrieveClassPropOffset(const std::string_view& className,
                                                  const std::string_view& propertyString);

    template<size_t size>
    static char* PropIndex(char (&buffer)[size], const char* base, int index)
    {
    ...
    inline static EntityOffset<TValue> GetEntityProp(const ClientClass* cc, const char* propertyString)
    {
    ...
    template<typename TValue>
    __forceinline static EntityOffset<TValue> GetEntityProp(IClientNetworkable* entity, const char* propertyString)
    {
        return GetEntityProp<TValue>((const ClientClass*)(entity->GetClientClass()), propertyString);
    }
    template<typename TValue>
    __forceinline static EntityOffset<TValue> GetEntityProp(const char* clientClassName, const char* propertyString)
    {
