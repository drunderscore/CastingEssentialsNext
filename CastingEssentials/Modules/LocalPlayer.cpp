...
LocalPlayer::LocalPlayer()
    : ce_localplayer_enabled(
          "ce_localplayer_enabled", "0", FCVAR_NONE, "enable local player override",
      ...
      ce_localplayer_set_current_target(
          "ce_localplayer_set_current_target", []() { GetModule()->SetToCurrentTarget(); },
          "set the local player to the current spectator target"),
      ce_localplayer_track_spec_target("ce_localplayer_track_spec_target", "0", FCVAR_NONE,
...
void LocalPlayer::ToggleEnabled(const ConVar* var) { m_GetLocalPlayerIndexHook.SetEnabled(var->GetBool()); }
