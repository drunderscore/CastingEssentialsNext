...
AntiFreeze::AntiFreeze()
    : ce_antifreeze_enabled("ce_antifreeze_enabled", "0", FCVAR_NONE,
...
void AntiFreeze::Panel::OnTick() { g_pVGuiPanel->GetPanel(GetVParent(), "ClientDLL")->OnCommand("performlayout"); }