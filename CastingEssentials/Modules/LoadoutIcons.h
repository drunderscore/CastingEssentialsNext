...
private:
    ...
    static constexpr const char* LOADOUT_ICONS[ITEM_COUNT][2] = {
        {"LoadoutIconsItem1Red", "LoadoutIconsItem1Blue"}, {"LoadoutIconsItem2Red", "LoadoutIconsItem2Blue"},
        {"LoadoutIconsItem3Red", "LoadoutIconsItem3Blue"}, {"LoadoutIconsItem4Red", "LoadoutIconsItem4Blue"},
        {"LoadoutIconsItem5Red", "LoadoutIconsItem5Blue"}, {"LoadoutIconsActiveItemRed", "LoadoutIconsActiveItemBlue"},
    };
