...
ConsoleTools::ConsoleTools() :
	ce_consoletools_filter_enabled("ce_consoletools_filter_enabled", "0", FCVAR_NONE, "Enables or disables console filtering.",
		...
		{
			// FIXME: This depends on hooking varargs member functions, which is not yet functional for 64-bit.
			Warning("!! Console filtering is non-functional in CastingEssentials Next, disabled to prevent console text corruption !!\n");
		}),
