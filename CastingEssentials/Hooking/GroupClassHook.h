...
template<class FuncEnumType, FuncEnumType hookID, bool vaArgs, class OriginalFnType, class DetourFnType,
         class FunctionalType, class Type, class RetVal, class... Args>
class BaseGroupClassHook : public BaseGroupGlobalHook<FuncEnumType, hookID, vaArgs, OriginalFnType, DetourFnType,
                                                      FunctionalType, RetVal, Args...>,
                           public IGroupClassHook<Type>
{
public:
    using BaseGroupClassHookType = BaseGroupClassHook<FuncEnumType, hookID, vaArgs, OriginalFnType, DetourFnType,
                                                      FunctionalType, Type, RetVal, Args...>;
    using BaseType = BaseGroupGlobalHook<FuncEnumType, hookID, vaArgs, OriginalFnType, DetourFnType, FunctionalType,
                                         RetVal, Args...>;
    using SelfType = BaseGroupClassHookType;
    ...
    virtual FunctionalType GetOriginal() override { return GetOriginalImpl(std::index_sequence_for<Args...>{}); }
...
protected:
    ...
    static Internal::LocalVaArgsFnPtr<Type, RetVal, Args...> LocalVaArgsDetourFn()
    {
        return [](Type* pThis, Args... args, ...) {
            ...
            static_assert(std::is_same<FmtType, const char*>::value || std::is_same<FmtType, char*>::value,
    ...
    BaseGroupClassHook(typename BaseType::ConstructorParam1* instance, typename BaseType::ConstructorParam2* detour)
        : BaseType((typename BaseType::ConstructorParam1*)detour)
    {
    ...
    FunctionalType GetOriginalImpl(std::index_sequence<Is...>)
    {
        ...
        {
            AssertMsg(
                0, "Should never get here... hook should be initialized so we don't have a potential race condition!");
            return nullptr;
        }
    }
};
...
class GroupClassHook<FuncEnumType, hookID, false, Type, RetVal, Args...>
    : public BaseGroupClassHook<FuncEnumType, hookID, false, Internal::LocalFnPtr<Type, RetVal, Args...>,
                                Internal::LocalDetourFnPtr<Type, RetVal, Args...>,
                                Internal::GlobalFunctionalType<RetVal, Args...>, Type, RetVal, Args...>
{
public:
    using BaseType = BaseGroupClassHook<FuncEnumType, hookID, false, Internal::LocalFnPtr<Type, RetVal, Args...>,
                                        Internal::LocalDetourFnPtr<Type, RetVal, Args...>,
                                        Internal::GlobalFunctionalType<RetVal, Args...>, Type, RetVal, Args...>;

    GroupClassHook(Type* instance, typename BaseType::OriginalFnType function,
                   typename BaseType::DetourFnType detour = nullptr)
        : BaseType(instance, function, detour)
    {
    }
