...
class BaseGroupManualClassHook : public BaseGroupGlobalHook<FuncEnumType, hookID, vaArgs, OriginalFnType, DetourFnType,
                                                            FunctionalType, RetVal, Type*, Args...>
{
public:
...
protected:
    ...
    Functional GetOriginalImpl(std::index_sequence<Is...>)
    {
        ...
        if (m_BaseHook)
        {
            ...
            std::function<RetVal(Type*, Args...)> fn =
                std::bind(patch, originalFnPtr, std::placeholders::_1, (std::_Ph<(int)(Is + 2)>{})...);
...
class GroupManualClassHook<FuncEnumType, hookID, false, Type, RetVal, Args...>
    : public BaseGroupManualClassHook<FuncEnumType, hookID, false, Internal::LocalFnPtr<Type, RetVal, Args...>,
...
public:
    ...
    using BaseType =
        BaseGroupManualClassHook<FuncEnumType, hookID, false, Internal::LocalFnPtr<Type, RetVal, Args...>,
                                 Internal::LocalDetourFnPtr<Type, RetVal, Args...>,
                                 Internal::LocalFunctionalType<Type, RetVal, Args...>, Type, RetVal, Args...>;
    using SelfType = GroupManualClassHookType;

    GroupManualClassHook(typename SelfType::OriginalFnType fn, typename SelfType::DetourFnType detour = nullptr)
        : BaseType(fn, detour)
    {
    }
